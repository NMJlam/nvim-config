  ...
  -- Greeter (Enhanced Alpha Dashboard)
  {
    ...
    config = function()
      ...
      dashboard.section.buttons.val = {
        ...
        dashboard.button("SPC f h", devicons.get_icon("history", "log") .. "  Recently used files", ":Telescope oldfiles <CR>"),
        dashboard.button("SPC f g", devicons.get_icon("search", "md") .. "  Find word", ":Telescope live_grep <CR>"),
        dashboard.button("c", devicons.get_icon("nvim", "lua") .. "  Configuration", ":e ~/.config/nvim/lua/plugins/init.lua <CR>"),
